...
from M2W2 import opt_utils
from M2W2 import testCase
...
# 普通梯度下降也还是会有比较严重的振荡，用样本平均代表整体还是会有偏差
...
# 这个例子比较简单，参数维数低，改进不明显，还是会存在震荡，接近梯度下降的结果
