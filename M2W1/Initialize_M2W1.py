...
from M2W1 import init_utils   # 第一部分，初始化
    ...
    for i in range(0, num_iterations):
        ...
        if i % 1000 == 0:
            ...
            if print_cost:
                ...
                # print("第" + str(i) + "次迭代，梯度值为：" + str(grads))
...
parameters = model(train_X, train_Y, initialization = "zeros",is_polt=True) # 根本没有学习，梯度为0
...
init_utils.plot_decision_boundary(lambda x: init_utils.predict_dec(parameters, x.T), train_X, train_Y) # 最后全分为0
# 用0初始化等价于单神经元的Logistic回归
